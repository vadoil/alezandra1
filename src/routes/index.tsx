    ...
    <section className="relative bg-cream pt-1 md:pt-28 pb-16 md:pb-20 overflow-hidden min-h-[88vh] flex flex-col">
      ...
      <div className="container-x relative flex-1 flex flex-col">
        ...
        <div className="grid lg:grid-cols-12 gap-0 lg:gap-8 items-stretch relative flex-1">
          ...
          <div className="lg:hidden order-2 relative z-0 -mt-14">
            <img
              src={heroSculpture}
      ...
      <div className="container-x grid lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        <div className="lg:col-span-5">
          <div className="relative w-full aspect-[3/4] flex items-center justify-center">
            <img
              src={statueAesthetic}
              alt="Александра Марченко — портрет"
              loading="lazy"
              width={860}
              height={1280}
        ...
        <div className="lg:col-span-7 lg:pl-8">
          ...
          <div className="mt-7 space-y-5 text-muted-foreground text-lg leading-relaxed max-w-xl">
            <p>
              Я пришла в йогу не за поиском себя, а за созданием себя. В мире, где все стремятся к «расслаблению», я выбрала дисциплину. Для меня тело — это не оболочка, а архитектурный объект, который требует идеальных пропорций, силы и статики.
            </p>
            <p>
              Мой метод <span className="font-serif-italic text-primary">«Body Frame»</span> — это не про мягкие перекаты на коврике. Это про геометрию, жёсткий контроль и осознанное владение каждым миллиметром своего пространства.
            </p>
            <p>
              Я не предлагаю «женские практики» или медитации. Я предлагаю систему критического выравнивания и силовой работы, которая меняет не только осанку, но и внутреннее состояние. Когда твой каркас непоколебим, ты транслируешь уверенность ещё до того, как начинаешь говорить.
            </p>
            <p>
              Я работаю с теми, кто ценит эстетику, результат и понимает, что тело — это главный актив. Мы не будем искать гармонию. Мы будем строить форму, которая подчиняется вашей воле.
            </p>
          </div>
